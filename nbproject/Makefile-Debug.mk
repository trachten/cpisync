...
${OBJECTDIR}/src/IBLT.o: src/IBLT.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I/opt/local/include -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IBLT.o src/IBLT.cpp
...
${OBJECTDIR}/src/IBLT_nomain.o: ${OBJECTDIR}/src/IBLT.o src/IBLT.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -I/opt/local/include -std=c++11 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/IBLT_nomain.o src/IBLT.cpp;\
	else  \

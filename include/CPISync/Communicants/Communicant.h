 ...
 */
  ...
  /**
     * Sends a list containing pairs
     * @param lst A list containing hash(ZZ) and elements(DataObject)
     **/
  void commSend(const list<pair<ZZ, list<DataObject *>>> &lst);
  ...
  list<pair<ZZ, list<DataObject *>>> commRecv_Pair_List();

...
## Use Instructions:
  ...
  3. Run listenSync and startSync on the server and client respectively
     ```cpp
         mySyncServer.serverSync(0); //Add the index of the sync you would like to perform
         mySyncClient.clientSync(0);  //Multiple syncs or communicants may be added to one GenSync
     ```
